...
This project contains a complete simulation framework for quadcopter UAV control using MATLAB and Simulink R2023a. It includes modeling, trajectory planning, parameter configuration, and 3D visualization.
